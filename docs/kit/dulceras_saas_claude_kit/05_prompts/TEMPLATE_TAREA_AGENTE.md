...
## Contexto leído
- 00_contexto/00_CONTEXTO_GENERAL.md
- 01_documentacion/02_REGLAS_DE_DESARROLLO.md
- [Módulo específico]
...
## Restricciones
[Stack, estilo, seguridad, multi-tenant]
