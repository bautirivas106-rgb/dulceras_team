...
## Objetivo
Avisar al administrador cuando se confirme una seña o pedido importante.

## MVP
Crear servicio abstracto `WhatsAppService`. Puede comenzar guardando logs y generando enlaces, pero la arquitectura debe permitir integrar proveedor real.

## Mensaje ejemplo
Nueva seña recibida en Dulceras Team. Pedido #1234. Cliente: Nombre. Total: $X. Seña: $Y. Fecha solicitada: DD/MM. Ver en dashboard.

## Reglas
- No bloquear el webhook si falla WhatsApp.
- Registrar éxito/error en `WhatsAppMessageLog`.
