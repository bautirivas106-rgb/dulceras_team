...
## Objetivo
Registrar compradores y facilitar recompra.

## Datos
Nombre, teléfono, email opcional, direcciones, historial de pedidos, notas internas.

## MVP
El cliente compra sin registrarse. El sistema crea o reutiliza cliente por teléfono/email.
