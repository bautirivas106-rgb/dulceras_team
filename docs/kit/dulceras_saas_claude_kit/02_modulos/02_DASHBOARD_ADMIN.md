...
## Objetivo
Panel moderno para administrar ventas, pedidos, señas, producción y productos.

## Home dashboard
- Pedidos nuevos.
- Pedidos con seña pagada.
...
## Estilo
Inspiración: Stripe, Shopify, Vercel, Notion, Linear. Minimalista, claro, responsive y profesional.

## Navegación
Dashboard, Pedidos, Producción, Calendario, Productos, Categorías, Clientes, Pagos, Notificaciones, Configuración.
