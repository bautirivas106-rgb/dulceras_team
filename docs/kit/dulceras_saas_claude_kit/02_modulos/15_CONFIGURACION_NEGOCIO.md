...
Branding, logo, colores, textos, horarios, zonas, métodos de entrega, porcentaje de seña, anticipación mínima, WhatsApp admin, Mercado Pago, módulos activos.

## Regla
Agregar una opción nueva no debe requerir cambiar código ni estructura principal si puede resolverse con configuración.
