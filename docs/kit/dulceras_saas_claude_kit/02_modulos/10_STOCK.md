...
- Bajo pedido: requiere producción y fecha futura.
- Stock inmediato: puede venderse si hay cantidad disponible.

## MVP
Stock puede ser simple: cantidad disponible por variante. Luego evolucionar a ingredientes e inventario.

## Regla
Si no hay stock y el producto no permite producción bajo pedido, no se puede vender.
