...
## Campanita
Debe aparecer en el dashboard. Al impactar una seña, crear notificación tipo `payment_received`.
...
## Campos
tenant, usuario destinatario opcional, tipo, título, mensaje, link, leído/no leído, fecha.
