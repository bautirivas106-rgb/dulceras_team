...
## Productos Dulceras iniciales
Cookies estilo NY, Budines, Tortas enteras, Postres bajoneros, Brownie Box, Chipá.

## Requisitos
- Categorías configurables por tenant.
- Productos con imágenes, descripción, precio base y estado activo/inactivo.
- Variantes: unidad, box de 4, box de 6, grande, chico, entera, porción, 1/4 kg, 1/2 kg.
- Producto puede requerir anticipación mínima.
- Producto puede tener stock inmediato o producción bajo pedido.

## Regla crítica
El precio del pedido debe copiarse al momento de comprar para no cambiar pedidos históricos si luego cambia el catálogo.
