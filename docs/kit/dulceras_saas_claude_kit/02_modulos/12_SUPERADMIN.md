...
## Objetivo
Permitir vender la plataforma a más negocios.
...
- Acceder a soporte sin romper seguridad.

## No confundir
El superadmin no es el admin de Dulceras. Es el dueño de la plataforma SaaS.
