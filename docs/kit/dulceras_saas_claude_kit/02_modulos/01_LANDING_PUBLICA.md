...
## Objetivo
Crear una landing visualmente hermosa, llamativa y moderna, basada en el estilo actual de Dulceras Team.

## Secciones
- Header con logo, navegación y CTA “Hacé tu pedido”.
- Hero: “La pastelería de Román”, “Un postre para vos, una ayuda para ellos”.
- Productos destacados.
- Categorías con cards grandes.
- Historia de Román y gatitos ayudados.
- Cómo pedir en pasos.
- Donaciones/causa gatitos.
- FAQ.
- Footer con contacto, Instagram y WhatsApp.

## Estilo
Cálido, artesanal, chic, dulce, bajonero. Usar paleta crema/rosa/marrón/chocolate, imágenes grandes, cards redondeadas, ilustraciones/gatitos sutiles, microanimaciones y CTAs claros.

## Prohibido
No hacer una landing corporativa fría. No eliminar la historia de Román. No transformar la marca en algo genérico.
