...
## Datos del pedido
Cliente, contacto, productos, variantes, fecha requerida, método entrega/retiro, dirección, total, seña, saldo restante, estado de pago, notas.

## Regla
Un pedido no debe pasar a confirmado hasta que Mercado Pago confirme la seña o un administrador lo confirme manualmente con motivo registrado.
