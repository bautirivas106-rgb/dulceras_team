# Módulo Producción y calendario
...
## Objetivo
Evitar tomar pedidos que no se pueden cumplir.

## Reglas
- Anticipación mínima global por negocio: 48 hs para Dulceras.
- Anticipación por producto: tortas pueden requerir más tiempo.
- Capacidad diaria por categoría/producto.
- Días no laborables y horarios configurables.

## Dashboard producción
Vista por fecha con pedidos confirmados, productos a preparar, cantidades y notas.
