...
## Tenant Admin
Control total del negocio: pedidos, productos, horarios, zonas, reportes, usuarios y configuración.

## Staff Producción
Ve pedidos confirmados, cola de producción, fechas y notas. No modifica pagos.

## Staff Caja
Ve pagos, señas, saldos pendientes y reportes.

## Platform Owner
Administra tenants, planes, activación de módulos, métricas globales y soporte.
