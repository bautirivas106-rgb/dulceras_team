...
El sistema debe resolver tres necesidades: vender mejor, ordenar la operación y permitir escalar como SaaS.

### Objetivos principales
- Aumentar conversión desde Instagram/WhatsApp.
- Evitar pedidos imposibles por falta de agenda, stock o capacidad productiva.
- Cobrar una seña para confirmar pedidos.
- Automatizar avisos al administrador.
- Mantener la esencia artesanal y solidaria de Dulceras Team.

### MVP obligatorio
- Landing pública.
- Catálogo con productos, categorías y variantes.
- Carrito.
- Checkout con datos del cliente.
- Selección de fecha, entrega o retiro.
- Pago de seña vía Mercado Pago.
- Webhook que confirme el pago.
- Dashboard con pedidos y notificaciones.
