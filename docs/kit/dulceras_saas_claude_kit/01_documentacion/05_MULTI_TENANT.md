...
## Modelo elegido para MVP
Single database + tenant_id en tablas principales. Es simple para empezar, compatible con SQL Server y suficiente para un SaaS inicial.

## Entidades principales
- Tenant: cliente de la plataforma.
- Business: datos comerciales y branding.
- User: usuario asociado a tenant.
- Role/Permission: permisos por negocio.
- FeatureFlag: módulos activos por tenant.
- Subscription: plan contratado.

## Seguridad obligatoria
Todo queryset del backoffice debe filtrarse por tenant del usuario. Nunca confiar en ids enviados desde frontend sin validar pertenencia.
