...
## Capas
- Frontend público: landing, catálogo, carrito, checkout y seguimiento del pedido.
- Frontend privado: dashboard del negocio y superadmin.
- API REST: reglas de negocio, autenticación, pagos, pedidos, notificaciones.
- Base SQL Server: multi-tenant, transaccional y auditable.
...
Toda entidad operativa debe estar asociada a un tenant/business: productos, categorías, pedidos, clientes, pagos, horarios, zonas, stock y usuarios.
