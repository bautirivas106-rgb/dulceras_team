...
## Fase 1 - MVP Dulceras
Landing, catálogo, carrito, seña Mercado Pago, dashboard pedidos, campanita y WhatsApp.

## Fase 2 - Operación
Producción, calendario, límites diarios, zonas, stock, reportes.

## Fase 3 - SaaS comercial
Superadmin, planes, onboarding de empresas, temas visuales configurables y facturación de suscripción.

## Fase 4 - Escala
WhatsApp API real, emails, analítica avanzada, cupones, cuentas de clientes y app móvil opcional.
