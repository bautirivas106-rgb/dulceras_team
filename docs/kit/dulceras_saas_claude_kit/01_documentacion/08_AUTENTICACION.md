...
Usar JWT para usuarios internos. Los clientes finales pueden comprar sin cuenta en MVP, pero se debe guardar customer por email/teléfono.
...
## Acceso público
Landing, catálogo y checkout son públicos, pero la creación de pedido debe validar captcha/rate limit en etapas futuras.
