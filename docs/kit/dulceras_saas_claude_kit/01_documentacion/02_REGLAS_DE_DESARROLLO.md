...
## Reglas técnicas
- Backend desacoplado del frontend mediante API REST.
- Nada crítico debe depender únicamente del frontend.
- Validar disponibilidad, producción, precio y seña en backend.
- Usar variables de entorno para credenciales.
- Diseñar pensando en tenants.
- Usar migraciones ordenadas.
- Evitar lógica de negocio en serializers o componentes React gigantes.

## Reglas de estilo visual
- Dulceras Team debe mantener tono cálido, artesanal, moderno y emocional.
- No usar dashboards genéricos tipo admin viejo.
- Evitar estética fría corporativa.
- Usar cards, bordes redondeados, sombras suaves, microinteracciones y buena fotografía.

## Regla de oro
Cada decisión debe contestar: ¿esto sirve solo para Dulceras o también para el próximo cliente gastronómico?
