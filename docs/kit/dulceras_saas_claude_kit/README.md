# Kit Claude / Vibe Coding - SaaS Gastronómico Dulceras Team
...
1. Primero darle a Claude el archivo `00_contexto/00_CONTEXTO_GENERAL.md`.
2. Luego darle `05_prompts/MASTER_PROMPT_CLAUDE.md`.
3. Después asignar los archivos de `03_agentes/` según el agente que vaya a trabajar.
4. Para cada módulo, adjuntar el `.md` correspondiente de `02_modulos/`.
5. Antes de programar, Claude debe leer `01_documentacion/02_REGLAS_DE_DESARROLLO.md` y `01_documentacion/04_ARQUITECTURA_GENERAL.md`.

## Objetivo
Construir una plataforma SaaS gastronómica multiempresa, con Dulceras Team como primer cliente, manteniendo su estilo visual actual pero modernizado.

## Entregables esperados
- Backend Django + DRF.
- Frontend React/Vite/TypeScript.
- SQL Server.
- Landing pública hermosa y responsive.
- Dashboard administrativo.
- Carrito y pedidos.
- Mercado Pago para señas.
- Webhook de pagos.
- Notificaciones internas con campanita.
- WhatsApp automático al administrador.
- Base multiempresa configurable.
