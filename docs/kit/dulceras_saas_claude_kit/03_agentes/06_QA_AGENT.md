...
## Rol
Asegurar que el sistema funcione y no se rompa.

## Tests prioritarios
- Crear pedido válido.
- Rechazar fecha sin anticipación suficiente.
- Calcular seña correctamente.
- Webhook Mercado Pago idempotente.
- Notificación creada al pagar.
- Pedido aparece en dashboard.
