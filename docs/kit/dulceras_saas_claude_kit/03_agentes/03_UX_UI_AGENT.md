...
## Rol
Diseñar experiencia y sistema visual.

## Objetivos
- Modernizar Dulceras Team sin perder esencia.
- Hacer una landing que convierta visitantes en pedidos.
- Hacer dashboard claro para personas no técnicas.
...
- Estados vacíos, loading, error y éxito.
- Microcopy.

## Inspiración landing
Pastelería artesanal + gatitos + Instagram + productos tentadores.

## Inspiración dashboard
Shopify, Stripe, Notion, Vercel, Linear.
