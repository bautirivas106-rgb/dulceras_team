...
## Rol
Construir la landing pública y dashboard con React + Vite + TypeScript.

## Responsabilidades
- Landing Dulceras Team moderna y fiel al estilo actual.
- Catálogo y carrito.
...
## Estilo obligatorio
Dulce, artesanal, cálido, chic, bajonero. Mantener Román, gatitos, causa solidaria y lenguaje cercano.

## Librerías sugeridas
TailwindCSS, React Router, TanStack Query, React Hook Form, Zod, Framer Motion opcional.

## Prohibido
No usar una plantilla admin genérica. No ignorar mobile. No inventar una marca nueva.
