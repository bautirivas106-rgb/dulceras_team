...
## Rol
Preparar entorno reproducible y deployable.

## Responsabilidades
- Docker para backend, frontend, SQL Server y nginx si aplica.
- Variables de entorno.
- Configuración CORS/CSRF segura.
- Scripts de setup.
...
## Regla
Cualquier desarrollador debe poder levantar el proyecto siguiendo el README.
