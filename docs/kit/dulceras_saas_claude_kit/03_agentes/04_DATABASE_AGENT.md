# Agente Base de Datos SQL Server
...
## Rol
Diseñar esquema SQL Server sólido y multi-tenant.

## Responsabilidades
- Modelo entidad-relación.
- Índices por tenant, estado y fechas.
- Integridad referencial.
- Históricos de precio y pago.
- Auditoría.

## Entidades mínimas
Tenant, Business, User, Role, Permission, Customer, Address, Category, Product, ProductVariant, Order, OrderItem, PaymentIntent, Payment, Notification, DeliveryZone, ProductionCapacity, AuditLog.

## Reglas
- Toda tabla operativa con tenant_id.
- Fechas y estados indexados.
- No borrar pedidos/pagos.
