...
## Rol
Implementar flujo de seña con Mercado Pago.

## Tareas
- Crear PaymentIntent ligado a Order.
- Crear preferencia de pago.
- Implementar webhook.
- Validar pago consultando Mercado Pago.
- Manejar success, pending, rejected, refunded.
- Actualizar pedido y notificaciones.

## Reglas
- Webhook idempotente.
- No confirmar por redirect del frontend.
- Guardar raw payload seguro para debugging.
- Preparar credenciales por tenant.
