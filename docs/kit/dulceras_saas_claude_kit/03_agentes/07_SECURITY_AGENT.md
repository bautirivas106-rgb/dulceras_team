...
- Webhook falso de Mercado Pago.
- Exposición de credenciales.
- Permisos mal aplicados.
- Manipulación de precio desde frontend.
- Spam de pedidos públicos.

## Reglas
- Validar todo en backend.
- Confirmar pagos consultando API oficial de Mercado Pago.
- Usar env vars.
- Rate limit en endpoints públicos cuando sea posible.
